package com.aoeng.play.http.image;
...
import com.aoeng.play.manager.ThreadManager;
import com.aoeng.play.manager.ThreadManager.ThreadPoolProxy;
import com.aoeng.play.utils.DrawableUtils;
...
import com.aoeng.play.utils.SystemUtils;
import com.aoeng.play.utils.UIUtils;

/**
 * 
 * @author aoeng Aug 31, 2014 11:52:43 AM
 */
public class ImageLoader {
	...
	private static Drawable loadFromNet(String url) {
		...
		FileUtils.write2File(stream, tempPath, true);// 把网络下载保存在本地
